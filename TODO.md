## This is work in progress, many features are missing ...
Overall Layout
- In the gui directory, create a global configuration file which holds the default path to the directory 
...
- The bin size in the calculation of the line spread function as a histogram 
  must be adjusted based on the diffraction-limited resolution, i.e. the cut-off frequency,
...
- Implement propagation and display of Gaussian beams using ray tracing of two rays (waist ray and divergence ray).
...
- Make n_air adjustable (1.0 versus 1.0003 at standard conditions).

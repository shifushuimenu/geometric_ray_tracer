...
class LensEditor(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.configTabs = ConfigTabs(self)
    ...
    def create_menus(self):
        ...
        set_pupils_and_stops_action = QAction(QIcon(), "&Pupils and Stops", self)
        set_fields_action = QAction(QIcon(), "&Fields", self)
        set_wavelengths_action = QAction(QIcon(), "&Wavelengths", self)        
        settingsMenu.addAction(set_pupils_and_stops_action)        
    ...
    def create_toolbar(self):
        ...
        raytrace_action = QAction(QIcon(), "&Raytrace", self)
        ...
        rayfan_action = QAction(QIcon(), "&Ray Fan Plot", self)
        ...
        # autofocus_action.triggered.connect(self.autofocus)
    ...
    def showRaytraceDiagram(self):
        if self.raytraceWindow is None:
            self.raytraceWindow = RaytraceDiagram()
...
class ConfigTabs(QWidget):
    ...
    def addNewConfig(self):
        ...
        current_tab = self.tabs_widget.currentWidget()
        try:
            new_tab = LensEditorConfig(current_tab)
            self.tabs.append(new_tab)
            self.tabs_widget.addTab(new_tab, "Config %d"%(self.counter))
        except TypeError as e:
            print(e)

    def removeConfig(self, index):
...
class LensEditorConfigBase(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.header_labels = ["Surface", "Stop flag", "Radius of curvature (mm)", "Thickness (mm)", "index of refraction n_d", "Abbe number V_d", "clear diameter (mm)"]
